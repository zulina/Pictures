...
var forms = function forms() {
  var form = document.querySelectorAll('form'); // при вводе номера убираем всё что не цифры
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            document.querySelector('.status').textContent = message.loading; // для постинга всегда указываем объект с параметрами
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); // добавляем элемент для вывода статуса

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage);
      var formData = new FormData(item); // отправляем данные на сервер
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', function () {
      ...
      Object(_calcScroll__WEBPACK_IMPORTED_MODULE_2__["modifyBody"])("", "0px");
